...
$this->registerJsFile('https://unpkg.com/@tonconnect/sdk@latest/dist/tonconnect-sdk.min.js', ['position' => \yii\web\View::POS_HEAD]);
        ...
        for (let wallet of walletsList) {
          ...
          if (wallet.embedded || wallet.injected) {
            ...
            connectButton.onclick = () => {
			  ...
			  window.open(connector.connect({
                universalLink: wallet.universalLink,
                bridgeUrl: wallet.bridgeUrl
              }), 'Walllet', width='500px',height='500px');
...
<div class="section" id="tonconnect-buttons"></div>
<!-- Hero Start -->
