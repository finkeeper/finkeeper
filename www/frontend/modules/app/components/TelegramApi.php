...
class TelegramApi {
	...
	const BotApiUrl = 'https://app.finkeeper.pro/v3/datas';
	...
	const ApiUrlCalc = 'https://app.finkeeper.pro/v3/datas/stakingcalc';
	const ApiUrlConv = 'https://app.finkeeper.pro/v3/datas/converter';
	const ApiUrlBybit = 'https://app.finkeeper.pro/v3/datas/bybitbalance';
	const ApiUrlTon = 'https://app.finkeeper.pro/v3/datas/tonconnect';
