...
function getAvailableRewards(client_1, checkAddress_1) {
    return __awaiter(this, arguments, void 0, function* (client, checkAddress, option = 1, prettyPrint = true) {
        ...
        try {
            const allResults = yield Promise.all(assetIds.map(assetId => getIncentivePools(client, assetId, option, checkAddress)));
            ...
            const summedRewards = activePools.reduce((acc, pool) => {
                ...
                let availableFixed = (Number(availableDecimal) / Math.pow(10, 9)).toFixed(5); // Adjust for 5 decimal places
                if (assetId == '13extra' || assetId == '15extra' || assetId == '16') {
                    availableFixed = (Number(availableDecimal) / Math.pow(10, 6)).toFixed(5); // coin for Decimals 6
                }
                if (!acc[assetId]) {
...
function claimAllRewardsPTB(client, userToCheck, tx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const rewardsSupply = yield getAvailableRewards(client, userToCheck, 1, false);
        ...
        const rewardsBorrow = yield getAvailableRewards(client, userToCheck, 3, false);
        // Convert the rewards object to an array of its values
