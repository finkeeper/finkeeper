...
Solana AI Hackathon [participant](https://www.solanaaihackathon.com/projects). Semi-final of the [TON Hackathon](https://blog.ton.org/hackers-league-semi-finalists-revealed). FinKeeper received a grant from Ston.fi (No. 1 DEX on TON with TVL over $150 million).
